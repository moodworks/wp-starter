...
function setup()
{
	...
	// Template locator.
	add_action('admin_bar_menu', $n('show_template_in_admin_bar'), 999);
	if (current_user_can('manage_options')) {
		add_action('wp_head', $n('template_locator_custom_css_and_js'), 0);
	}
...
function template_locator_custom_css_and_js()
{
	echo '<style>
